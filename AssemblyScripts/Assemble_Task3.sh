...
cd /N/dc2/projects/muri2/Task3/
AR=(<Insert Folder Names Here>)
...
do
	...
	echo "" >> Task3${i}_qc_clean.sh
	echo "cd /N/dc2/projects/muri2/Task3/${i}" >> Task3${i}_qc_clean.sh
	echo "" >> Task3${i}_qc_clean.sh
...
#### Assembly script for E. coli Reads####
	...
	echo "" >> Task3${i}_EcoliAssemble.sh
	echo "cd /N/dc2/projects/muri2/Task3/${i}/" >> Task3${i}_EcoliAssemble.sh
	echo "" >> Task3${i}_EcoliAssemble.sh
	...
	echo "" >> Task3${i}_RpalAssemble.sh
	echo "cd /N/dc2/projects/muri2/Task3/${i}/" >> Task3${i}_RpalAssemble.sh
	echo "" >> Task3${i}_RpalAssemble.sh
	echo "echo \"BWA\" >&2" >> Task3${i}_RpalAssemble.sh
	echo "time bwa mem /N/dc2/projects/muri2/Task3/RefGenome/R_palustris/R_pal.RefGenome.fna Sample_${i}_R1_trimmed.fastq Sample_${i}_R2_trimmed.fastq > Sample_${i}.Rpal.sam" >> Task3${i}_RpalAssemble.sh
   	echo "" >> Task3${i}_RpalAssemble.sh
	echo "echo \"SAMTOOLS\" >&2" >> Task3${i}_RpalAssemble.sh
	echo "samtools view -bS -T /N/dc2/projects/muri2/Task3/RefGenome/R_palustris/R_pal.RefGenome.fna Sample_${i}.Rpal.sam > Sample_${i}.Rpal.bam" >> Task3${i}_RpalAssemble.sh
	echo "" >> Task3${i}_RpalAssemble.sh
	...
	echo "GATK" >&2
	echo "java -Xmx2g -classpath "/N/soft/rhel6/picard/picard-tools-1.107/" -jar /N/soft/rhel6/gatk/3.4-0/GenomeAnalysisTK.jar  -R /N/dc2/projects/muri2/Task3/RefGenome/R_palustris/R_pal.RefGenome.fna -I Sample_${i}.Rpal.sorted.fixed.marked.bam -T RealignerTargetCreator -o Sample_${i}.Rpal.intervals" >> Task3${i}_RpalAssemble.sh
	echo "java -Xmx2g -classpath "/N/soft/rhel6/picard/picard-tools-1.107/" -jar /N/soft/rhel6/gatk/3.4-0/GenomeAnalysisTK.jar -R /N/dc2/projects/muri2/Task3/RefGenome/R_palustris/R_pal.RefGenome.fna -I Sample_${i}.Rpal.sorted.fixed.marked.bam -T IndelRealigner -targetIntervals Sample_${i}.Rpal.intervals --filter_bases_not_stored -o Sample_${i}.Rpal.sorted.fixed.marked.realigned.bam" >> Task3${i}_RpalAssemble.sh
	echo "java -Xmx2g -classpath "/N/soft/rhel6/picard/picard-tools-1.107/" -jar /N/soft/rhel6/gatk/3.4-0/GenomeAnalysisTK.jar -nt 4 -T UnifiedGenotyper -R /N/dc2/projects/muri2/Task3/RefGenome/R_palustris/R_pal.RefGenome.fna -I Sample_${i}.Rpal.sorted.fixed.marked.realigned.bam -glm BOTH -rf BadCigar -o Sample_${i}.Rpal.sorted.fixed.marked.realigned.vcf" >> Task3${i}_RpalAssemble.sh
	echo "java -Xmx2g -classpath "/N/soft/rhel6/picard/picard-tools-1.107/" -jar /N/soft/rhel6/gatk/3.4-0/GenomeAnalysisTK.jar  -T BaseRecalibrator -I Sample_${i}.Rpal.sorted.fixed.marked.realigned.bam -R /N/dc2/projects/muri2/Task3/RefGenome/R_palustris/R_pal.RefGenome.fna -rf BadCigar --filter_bases_not_stored -knownSites Sample_${i}.Rpal.sorted.fixed.marked.realigned.vcf -o Sample_${i}.Rpal.recal_data.grp" >> Task3${i}_RpalAssemble.sh
	echo "java -Xmx2g -classpath "/N/soft/rhel6/picard/picard-tools-1.107/" -jar /N/soft/rhel6/gatk/3.4-0/GenomeAnalysisTK.jar  -R /N/dc2/projects/muri2/Task3/RefGenome/R_palustris/R_pal.RefGenome.fna -I Sample_${i}.Rpal.sorted.fixed.marked.realigned.bam -T PrintReads -rf BadCigar  -o Sample_${i}.Rpal.mapped.bam -BQSR Sample_${i}.Rpal.recal_data.grp" >> Task3${i}_RpalAssemble.sh
	#java -Xmx2g -classpath /N/soft/rhel6/picard/picard-tools-1.107/ -jar /N/soft/rhel6/gatk/3.4-0/GenomeAnalysisTK.jar -nt 4 -T UnifiedGenotyper -R ../../Ecoli_RefGenome/Ecoli_K12_MG1655.fna -I Sample_${i}.sorted.fixed.marked.realigned.bam -rf BadCigar -o Sample_${i}.sorted.fixed.marked.realigned.vcf" >> Task3${i}_EcoliAssemble.sh
	echo "" >> Task3${i}_RpalAssemble.sh
	...
	echo "" >> Task3${i}_compress.fastq.sh
	echo "cd /N/dc2/projects/muri2/Task3/${i}/" >> Task3${i}_compress.fastq.sh
	...
	echo "" >> Task3${i}_RpalRetroSeq.sh
	echo "cd /N/dc2/projects/muri2/Task3/${i}/"  >>Task3${i}_RpalRetroSeq.sh
	echo "mkdir R_pal_InsSeq" >> Task3${i}_RpalRetroSeq.sh
	echo "cd R_pal_InsSeq" >>Task3${i}_RpalRetroSeq.sh
	echo "time bwa mem /N/dc2/projects/muri2/Task3/RefGenome/R_palustris/InsSeq/RefGenome/R_pal.RefGenome.fna ../Sample_${i}_R1_trimmed.fastq ../Sample_${i}_R2_trimmed.fastq > Sample_${i}.sam" >> Task3${i}_RpalRetroSeq.sh
	echo "samtools view -bS -T /N/dc2/projects/muri2/Task3/RefGenome/R_palustris/InsSeq/RefGenome/R_pal.RefGenome.fna Sample_${i}.sam > Sample_${i}.bam" >> Task3${i}_RpalRetroSeq.sh
	...
	echo "perl /N/dc2/projects/muri2/Tools/RetroSeq/bin/retroseq.pl -discover -eref /N/dc2/projects/muri2/Task3/RefGenome/R_palustris/InsSeq/Rpal_IS_RefFile.txt -bam Sample_${i}.sorted.bam -output Sample_${i}.IS.Reads -align" >> Task3${i}_RpalRetroSeq.sh
	echo "perl /N/dc2/projects/muri2/Tools/RetroSeq/bin/retroseq.pl -call -bam Sample_${i}.sorted.bam -ref /N/dc2/projects/muri2/Task3/RefGenome/R_palustris/InsSeq/RefGenome/R_pal.RefGenome.fna -output Sample_${i}.Rpal.IS -input Sample_${i}.IS.Reads -hets" >>Task3${i}_RpalRetroSeq.sh
	echo "" >> Task3${i}_RpalRetroSeq.sh
